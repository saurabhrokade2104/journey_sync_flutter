...
import 'package:finovelapp/views/components/text/default_text.dart';
...
class WarningAlertDialog extends StatelessWidget {
  ...
  const WarningAlertDialog(
      {super.key, this.header = '', this.body = '', required this.onPressed});

  @override
  Widget build(BuildContext context) {
    return Dialog(
      insetPadding:
          const EdgeInsets.symmetric(horizontal: Dimensions.space40 * 1.5),
      alignment: Alignment.center,
      shape: RoundedRectangleBorder(
          borderRadius:
              BorderRadius.circular(Dimensions.defaultBorderRadius * 2)),
      child: SingleChildScrollView(
        physics:
            const ClampingScrollPhysics(), // use this scroll physics for removing height  issues
        child: Container(
          alignment: Alignment.center,
