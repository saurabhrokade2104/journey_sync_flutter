...
import 'package:finovelapp/views/components/text-field/code_picker_widget.dart';
...
class CustomTextFieldPhone extends StatefulWidget {
  ...
  @override
  CustomTextFieldPhoneState createState() => CustomTextFieldPhoneState();
}

class CustomTextFieldPhoneState extends State<CustomTextFieldPhone> {
    ...
    return Column(
      ...
      children: [
        ...
        TextFormField(
          ...
          onSaved: (text) => widget.nextFocus != null ? FocusScope.of(context).requestFocus(widget.nextFocus)
