...
class DownloadingDialog extends StatefulWidget {
  ...
  const DownloadingDialog(
      {super.key, required this.url, this.isPdf = true, required this.fileName});
    ...
    try {
      ...
      setState(() {
        ...
        CustomSnackBar.error(errorList: [
          '${MyStrings.errorDownloadingFile.tr} : ${e.toString()}'
        ]);
      });
    }
  }
    ...
    return AlertDialog(
      ...
      content: Column(
        ...
        children: [
          ...
          Text(MyStrings.downloading.tr, style: interRegularDefault),
        ],
      ),
    );
  }
