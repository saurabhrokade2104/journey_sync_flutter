...
import 'package:finovelapp/data/controller/otp/otp_controller.dart';
import 'package:finovelapp/data/repo/otp/otp_repo.dart';
...
import 'package:finovelapp/views/components/timer/timer.dart';
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
          ...
          appBar: CustomAppBar(title: MyStrings.otpVerification),
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        Text(MyStrings.enterYourOTPCode.tr,
                            style: interRegularMediumLarge.copyWith(
                                color: MyColor.colorBlack,
                                fontWeight: FontWeight.w600)),
                        const SizedBox(height: Dimensions.space10),
                        Text(
                            controller.otpType == "sms"
                                ? MyStrings.sixDigitSMSOtpMsg
                                : controller.otpType == "email"
                                    ? MyStrings.sixDigitEmailOtpMsg
                        ...
                        Padding(
                          ...
                          child: PinCodeTextField(
                            ...
                            length: 6,
                            textStyle: interRegularLarge.copyWith(
                                color: MyColor.getPrimaryColor()),
                            obscuringCharacter: '*',
                        ...
                        Row(
                          ...
                          children: [
                            controller.isOtpExpired
                                ? Row(
                                    children: [
                                      Text(MyStrings.otpHasBeenExpired.tr,
