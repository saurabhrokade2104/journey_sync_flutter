import 'package:finovelapp/data/controller/auth/auth/login_verification_controler.dart';
...
class LoginSmsVerificationScreen extends StatefulWidget {
  const LoginSmsVerificationScreen({super.key});

  @override
  State<LoginSmsVerificationScreen> createState() => _LoginSmsVerificationScreenState();
}

class _LoginSmsVerificationScreenState extends State<LoginSmsVerificationScreen> {
  @override
  void initState() {
    Get.put(ApiClient(sharedPreferences: Get.find()));
    Get.put(SmsEmailVerificationRepo(apiClient: Get.find()));
    // Ensure LoginController is available in dependencies
  final loginController = Get.find<LoginController>();
    final controller = Get.put(LoginSmsVerificationController(repo: Get.find(),loginController: loginController,));
    super.initState();
    WidgetsBinding.instance.addPostFrameCallback((_) {
      // controller.isProfileCompleteEnable = Get.arguments[0];
      // controller.isTwoFactorEnable = Get.arguments[1];
      controller.phoneNumber = Get.arguments[0];
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: GetBuilder<LoginSmsVerificationController>(
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text("We've sent you an otp to your phone number ${controller.phoneNumber} for verification",
                              maxLines: 2,
