...
import 'package:finovelapp/data/controller/auth/two_factor_controller.dart';
import 'package:finovelapp/data/repo/auth/two_factor_repo.dart';
...
class TwoFactorVerificationScreen extends StatefulWidget {
  ...
  const TwoFactorVerificationScreen(
      {super.key, required this.isProfileCompleteEnable});
