...
import 'package:finovelapp/data/controller/auth/forget_password/forget_password_controller.dart';
...
import 'package:finovelapp/views/components/heading_text_widget.dart';
              ...
              child: Column(
                ...
                children: [
                  ...
                  CustomTextField(
                      ...
                      onChanged: (value) {
                         print("Text changed: $value"); // Debug Print
                        return;
                      },
                      validator: (value) {
                        print("Validator called: $value"); // Debug Print
                        if (controller
