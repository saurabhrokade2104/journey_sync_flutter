...
import 'package:finovelapp/data/repo/withdraw/withdraw_history_repo.dart';
...
import 'package:finovelapp/views/screens/withdraw/widget/custom_withdraw_card.dart';
import 'package:finovelapp/views/screens/withdraw/widget/withdraw_bottom_sheet.dart';
import 'package:finovelapp/views/screens/withdraw/widget/withdraw_history_top.dart';
  ...
  Widget build(BuildContext context) {
    return GetBuilder<WithdrawHistoryController>(
      builder: (controller) => WillPopWidget(
        nextRoute: controller.isGoHome() ? RouteHelper.bottomNavScreen : '',
        isOnlyBack: controller.isGoHome() ? false : true,
        child: SafeArea(
          child: Scaffold(
            backgroundColor: MyColor.containerBgColor,
            appBar: AppBar(
              title: Text(MyStrings.withdrawals.tr,
