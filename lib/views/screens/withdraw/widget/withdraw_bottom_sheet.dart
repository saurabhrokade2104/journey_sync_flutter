...
import 'package:finovelapp/data/controller/withdraw/withdraw_history_controller.dart';
import 'package:finovelapp/data/model/withdraw/withdraw_history_response_model.dart';
...
import 'package:finovelapp/views/components/text/bottom_sheet_label_text.dart';
              ...
              children: [
                ...
                Expanded(
                    ...
                    child: LabelColumn(
                        ...
                        body:
                            '${controller.curSymbol}${Converter.formatNumber(controller.withdrawList[index].charge ?? '')}')),
              ],
            ),
              ...
              children: [
                Expanded(
                    ...
                    child: LabelColumn(
                        ...
                        body:
                            '${controller.curSymbol}${Converter.formatNumber(controller.withdrawList[index].afterCharge ?? '')}')),
                Expanded(
                    flex: 4,
                    child: LabelColumn(
                        alignmentEnd: true,
                        ...
                        body:
                            '1 ${controller.currency} = ${Converter.formatNumber(controller.withdrawList[index].rate ?? '')} ${controller.withdrawList[index].currency}')),
              ],
            ),
            const SizedBox(height: Dimensions.space20),
            Row(
              ...
              children: [
                Expanded(
                    ...
                    child: LabelColumn(
                        ...
                        body:
                            '${controller.curSymbol}${Converter.formatNumber(controller.withdrawList[index].finalAmount ?? '0')}')),
                Expanded(
                    flex: 3,
                    child: LabelColumn(
                        alignmentEnd: true,
                        header: MyStrings.paymentMethod,
                        body: Converter.formatNumber(
                    ...
                    SizedBox(
                      child: ListView.builder(
                        ...
                        itemBuilder: (BuildContext context, int detailsIndex) {
                          Details? details = controller
                              .withdrawList[index].details?[detailsIndex];
                          return Container(
