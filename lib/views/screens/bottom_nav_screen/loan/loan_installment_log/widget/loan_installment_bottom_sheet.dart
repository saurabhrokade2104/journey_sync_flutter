...
import 'package:finovelapp/data/controller/loan/loan_installment_log_controller.dart';
                      ...
                      children: [
                          ...
                          children: [
                            Expanded(
                                child: BottomSheetColumn(
                                    ...
                                    body: controller.loan?.plan?.name ?? '')),
                            const SizedBox(
                              width: 10,
                            ),
                            Expanded(
                                child: BottomSheetColumn(
                                    alignmentEnd: true,
                                    header: MyStrings.loanNumber,
                                    body: controller.loan?.loanNumber ?? '')),
                          ],
                        ),
                        ...
                        Row(
                          ...
                          children: [
                            Expanded(
                              child: BottomSheetColumn(
                                  header: MyStrings.loanAmount,
                                  body:
                                      '${Converter.formatNumber(controller.loan?.amount ?? '0', precision: 2)} ${controller.currency}'),
                            ),
                            Expanded(
                                child: BottomSheetColumn(
                                    alignmentEnd: true,
                                    ...
                                    body:
                                        '${Converter.formatNumber(controller.loan?.perInstallment ?? '0', precision: 2)} ${controller.currency}')),
                          ],
                        ),
                        const SizedBox(
                          height: 15,
                          ...
                          children: [
                            Expanded(
                                child: BottomSheetColumn(
                                    ...
                                    body: (controller.loan?.totalInstallment ??
                                            '0')
                                        .padLeft(2, '0'))),
                            ...
                            Expanded(
                                child: BottomSheetColumn(
                                    ...
                                    body: (controller.loan?.givenInstallment ??
                                            '0')
                                        .padLeft(2, '0'))),
                          ],
                        ),
                        ...
                        Row(
                          ...
                          children: [
                            Expanded(
                              ...
                              body:
                                  '${Converter.mul(controller.loan?.perInstallment ?? '0', controller.loan?.totalInstallment ?? '0')} ${controller.currency}',
                            )),
                            Expanded(
                                child: BottomSheetColumn(
                              alignmentEnd: true,
                              ...
                              body:
                                  '${Converter.formatNumber(controller.loan?.chargePerInstallment ?? '0')} ${controller.currency} /${MyStrings.day.tr}',
                            )),
                          ],
                        ),
                        const SizedBox(
                        ...
                        Text(
                          '*${MyStrings.chargeWillBeApplyMsg.tr} ${controller.loan?.delayValue ?? '1'} ${MyStrings.orMoreDays.tr}'
                              .tr,
