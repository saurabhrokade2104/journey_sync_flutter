...
import 'package:finovelapp/views/components/row_item/warning_row.dart';

import '../../../../../components/text-field/custom_amount_text_field.dart';

class AllLoanApplyBottomSheet {
          ...
          Form(
            child: Column(
              ...
              children: [
                ...
                WarningRow(
                  text:
                      '${MyStrings.limit.tr}: ${controller.currencySymbol}${Converter.formatNumber(controller.planList[index].minimumAmount ?? '0')} - ${controller.currencySymbol}${Converter.formatNumber(controller.planList[index].maximumAmount ?? '0')}',
                ),
                ...
                controller.submitLoading
                    ...
                    : RoundedButton(
                        press: () {
                          String planId =
                              controller.planList[index].id.toString();

                          controller.submitAllLoanPlan(planId, index);
                        },
