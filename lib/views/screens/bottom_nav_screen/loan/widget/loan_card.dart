      ...
      builder: (controller) => GestureDetector(
        ...
        child: Container(
          ...
          decoration: BoxDecoration(
              ...
              border: Border.all(color: isShowBorder?MyColor.borderColor:Colors.transparent,width: isShowBorder? .6:0),
                      ...
                      children: [
                        ...
                        RichText(
                          text: TextSpan(children: [
                            ...
                            TextSpan(
                                text:
                                    "$installmentInterval ${MyStrings.days.tr}",
                                style: interRegularSmall.copyWith(
                                    color: MyColor.smallTextColor1)),
                          ]),
                        ),
