...
import 'package:finovelapp/data/controller/loan/loan_confirm_controller.dart';
...
import 'package:finovelapp/views/components/checkbox/custom_check_box.dart';
import 'package:finovelapp/views/components/custom_loader.dart';
import 'package:finovelapp/views/components/custom_radio_button.dart';
...
import 'package:finovelapp/views/components/text-field/custom_drop_down_button_with_text_field.dart';
import 'package:finovelapp/views/components/text-field/custom_text_field.dart';
import 'package:finovelapp/views/screens/bottom_nav_screen/loan/loan_confirm_screen/widget/preview_row.dart';

import 'package:finovelapp/views/screens/withdraw/confirm_withdraw_screen/widget/choose_file_list_item.dart';
                                ...
                                child: Container(
                                    ...
                                    child: Column(
                                        ...
                                        children: [
                                          ...
                                          PreviewRow(
                                              firstText: MyStrings.planName,
                                              secondText: controller.planName),
                                          PreviewRow(
                                              firstText: MyStrings.loanAmount,
                                              secondText:
                                                  '${controller.currencySymbol}${controller.amount}'),
                                          PreviewRow(
                                              firstText:
                                                  MyStrings.totalInstallment,
                                              secondText:
                                                  controller.totalInstallment),
                                          PreviewRow(
                                              firstText:
                                                  MyStrings.perInstallment,
                                              secondText:
                                                  '${controller.currencySymbol}${controller.perInstallment}'),
                                          PreviewRow(
                                            firstText: MyStrings.youNeedToPay,
                                            secondText:
                                                '${controller.currencySymbol}${controller.youNeedToPay}',
                                          ),
                                          PreviewRow(
                                            firstText: MyStrings.applicationFee,
                                            secondText:
                                                '${controller.currencySymbol}${controller.applicationFee}',
                                            secondTextStyle:
                            ...
                            Flexible(
                              child: Container(
                                ...
                                child: Column(
                                  ...
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text(MyStrings.applicationForm.tr,
                                        style: header),
                                    const CustomDivider(
                                      space: 15,
                                    ),
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      CustomRadioButton(
                                                                        title: model
                                                                            .name,
                                                                        selectedIndex:
                                                                            controller.formList[index].options?.indexOf(model.selectedValue ?? '') ??
                                                                                0,
                                                                        list: model.options ??
                                                                            [],
                                                                        onChanged:
                                                                ...
                                                                : model.type ==
                                                                    ...
                                                                    ? Column(
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          CustomCheckBox(
                                                                            selectedValue:
                                                                                controller.formList[index].cbSelected,
                                                                            list:
                                                                                model.options ?? [],
                                                                            onChanged:
                                                                                (value) {
