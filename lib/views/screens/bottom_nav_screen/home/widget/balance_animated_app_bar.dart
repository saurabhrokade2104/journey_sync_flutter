...
class BalanceAnimationContainer extends StatefulWidget {
  const BalanceAnimationContainer(
      {super.key, required this.amount, required this.curSymbol});
  final String amount;
          ...
          children: [
            ...
            AnimatedOpacity(
              ...
              child: Text(
                ...
                style:
                    const TextStyle(color: MyColor.primaryColor, fontSize: 14),
              ),
            ),
