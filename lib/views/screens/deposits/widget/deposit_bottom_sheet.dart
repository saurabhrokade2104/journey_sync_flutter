      ...
      child: GetBuilder<DepositController>(
          builder: (controller) => Column(
                ...
                children: [
                        ...
                        children: [
                          Expanded(
                              child: BottomSheetColumn(
                                  ...
                                  body: controller
                                          .depositList[index].gateway?.name ??
                                      '')),
                          Expanded(
                              child: BottomSheetColumn(
                                  alignmentEnd: true,
                  ...
                  Visibility(
                    visible: controller.depositList[index].detail != null &&
                        controller.depositList[index].detail!.isNotEmpty,
                          ...
                          SizedBox(
                            child: ListView.builder(
                              ...
                              itemCount: controller
                                      .depositList[index].detail?.length ??
                                  0,
                              itemBuilder:
                                  (BuildContext context, int detailsIndex) {
                                Details? details = controller
                                    .depositList[index].detail?[detailsIndex];
                                if (details?.value != null &&
                                    details!.value.toString().isNotEmpty &&
