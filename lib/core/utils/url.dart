...
class UrlContainer {
  ...
  static const String domainUrl = 'https://unikleads.store/';
  // static const String domainUrl = 'http://15.206.80.147/';
  ...
  static const String sendOtpPhone = 'send-otp-phone';
  static const String verifyOtpPhone = 'verify-otp-phone';
  static const String sendOtpEmail = 'send-otp-email';
  static const String verifyOtpEmail = 'verify-otp-email';
  static const String sandboxAuthenticate = 'authenticate';
  static const String submitBankDetails = 'submit-bank-details';
  static const String submitUPIDetails = 'submit-upi-details';
  static const String submitDeviceData = 'updateUserData';
  static const String userDashboardEndPoint = 'user/home';
  static const String userLogoutEndPoint = 'logout';
  static const String summerSalesEndpoint = 'leads/dashboard';
  static const String channelPartnerDashboardEndpoint = 'leads/dashboard/channel-partner';
  static const String leadApplicationTrackerEndpoint = 'leads';
  ...
  static const String verifyLoginSmsEndPoint = 'verify-login-otp';
  ...
  static const String withdrawConfirmScreenUrl = 'withdraw-request';
  ...
  static const String transferAmount = 'initiate-transfer';
  static const String addLeadFormUrl = 'leads';
  static const String submitEligibilityFormDetals = 'loan/check-eligibility';
  static const String canCheckEligibility = 'eligibility/check';
  static const String eligibilityFormUserData = 'eligibility/last-data';
  static const String myloanListUrl = 'loan/my-loans';
  ...
  String apiKey = 'key_live_6ntRaCVwvU6BCNDmDwmOOUrRdFKb18RO';
  String apiSecret = 'secret_live_2Rre57P8Zlx7FuiOuU2asiKrNp6ES3GM';