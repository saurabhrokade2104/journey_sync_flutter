...
import 'package:finovelapp/data/model/auth/verification/email_verification_model.dart';
...
class LoginRepo {
  ...
  Future<ResponseModel> loginWithMobile(String phone) async {
    Map<String, String> map = {"mobile": phone};
  ...
  Map<String, String> deviceTokenMap(String deviceToken) {
   ...
   Future<ResponseModel> getUserData() async {
    ...
    debugPrint('url requesting auth: $url');
    ResponseModel response =
        await apiClient.request(url, Method.getMethod, null, passHeader: true,isBioMetricLogin: false);
    return response;
  }
}
