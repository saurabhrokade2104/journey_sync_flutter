...
import 'package:finovelapp/core/utils/method.dart' as request;
...
// import 'package:finovelapp/data/model/withdraw/withdraw_preview_response_model.dart';
...
class WithdrawRepo {
  ...
  Future<dynamic> addWithdrawRequest(
      int methodCode, double amount, String? authMode) async {
