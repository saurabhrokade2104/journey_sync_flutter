...
import 'package:finovelapp/data/model/auth/error_model.dart';
import 'package:finovelapp/data/model/auth/registration_response_model.dart';
import 'package:finovelapp/data/model/auth/sign_up_model/sign_up_model.dart';
import 'package:finovelapp/data/model/country_model/country_model.dart';
  ...
  signUpUser() async {
    if (countryName == null) {
      CustomSnackBar.error(
        errorList: [MyStrings.selectACountry],
      );
      update();
      return;
    }
    ...
    if (mobileController.text.isEmpty) {
      CustomSnackBar.error(
        errorList: [MyStrings.enterYourPhoneNumber],
      );
      return;
    }
  ...
  void initData() async {
    ...
    needAgree =
        generalSettingMainModel.data?.generalSetting?.agree.toString() == '0'
            ? false
            : true;
    checkPasswordStrength = generalSettingMainModel.data?.generalSetting?.securePassword.toString() ==
            '0'
        ? false
        : true;
