...
import 'package:finovelapp/views/components/file_download_dialog/download_dialogue.dart';
...
class WithdrawHistoryController extends GetxController {
  ...
  Future<void> loadWithdrawData() async {
    ...
    ResponseModel responseModel = await withdrawHistoryRepo
        .getWithdrawHistoryData(page, searchText: searchText);
  ...
  bool isGoHome() {
    ...
    if (previousRoute == RouteHelper.notificationScreen ||
        previousRoute == RouteHelper.menuScreen) {
      return false;
    } else {
      return true;
    }
