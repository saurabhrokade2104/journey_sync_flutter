...
import 'package:finovelapp/data/model/notification/notification_response_model.dart';
...
class NotificationsController extends GetxController {
  ...
  Future<void> initData() async {
    ...
    if (response.statusCode == 200) {
      NotificationResponseModel model =
          NotificationResponseModel.fromJson(jsonDecode(response.responseJson));
  ...
  Future<bool> markAsReadAndGotoThePage(int index) async {
    ...
    if (remark != null && remark.isNotEmpty) {
      ...
      if (response.statusCode == 200) {
        auth.AuthorizationResponseModel model =
            auth.AuthorizationResponseModel.fromJson(
  ...
  bool hasUnread = notificationList.any((notification) => notification.view == '0');
  print("Has unread notifications: $hasUnread"); // Debug log
  return hasUnread;
}
