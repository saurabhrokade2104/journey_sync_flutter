...
import 'package:finovelapp/data/model/transaction/transaction_response_model.dart';
...
class TransactionController extends GetxController {
  ...
  Future<void> loadTransaction() async {
    ...
    if (page == 1) {
      currency = transactionRepo.apiClient.getCurrencyOrUsername(isSymbol: true);
      remarksList.clear();
