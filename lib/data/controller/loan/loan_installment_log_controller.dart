...
import 'package:finovelapp/data/model/loan/loan_installment_response_model.dart';
...
class LoanInstallmentLogController extends GetxController {
  ...
  Future<void> loadInstallmentLog() async {
    ...
    ResponseModel responseModel =
        await loanRepo.getLoanInstallmentLog(loanId, page);
    if (responseModel.statusCode == 200) {
      LoanInstallmentResponseModel model =
          LoanInstallmentResponseModel.fromJson(
