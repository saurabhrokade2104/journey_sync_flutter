...
class BigLoanApplyController extends GetxController {
  ...
  BigLoanApplyController({required this.loanRepo}) {
    ...
    assert(() {
      ...
      bankNameController.text = 'HDFC BANK'; // Example bank name
      ifscCodeController.text = 'HDFC0005819'; // Example IFSC code
      accountHolderNameController.text =
          'Ankit Kumar'; // Example account holder name
      accountNumberController.text = '50100416682121'; // Example account number
      confirmAccountNumberController.text =
          '50100416682121'; // Example confirm account number
