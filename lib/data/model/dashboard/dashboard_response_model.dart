...
class Data {
  ...
  Data.fromJson(dynamic json) {
    ...
    _dashboardData = json['dashboard_data'] != null
        ...
        : null;
    _latestCredits = json['latest_credits'] != null
        ? LatestCredits.fromJson(json['latest_credits'])
        : null;
    _latestDebits = json['latest_debits'] != null
        ? LatestDebits.fromJson(json['latest_debits'])
        : null;
    _runningLoanList = json["running_loans"] == null
        ? []
        : List<RunningLoanModel>.from(
            json["running_loans"]!.map((x) => RunningLoanModel.fromJson(x)));
  }
...
class LatestDebits {
  LatestDebits(
      {List<LatestDebitsData>? data, dynamic nextPageUrl, String? path}) {
    _data = data;
...
class LatestCredits {
  LatestCredits(
      {List<LatestCreditsData>? data, dynamic nextPageUrl, String? path}) {
    _data = data;
    _nextPageUrl = nextPageUrl;
    _path = path;
  }
...
class LatestCreditsData {
  ...
  LatestCreditsData.fromJson(dynamic json) {
    ...
    _postBalance =
        json['post_balance'] != null ? json['post_balance'].toString() : '00';
    _trxType = json['trx_type'].toString();
    _trx = json['trx'].toString();
...
class User {
  User({
   ...
   bool isUpiVerified = false,
    ...
    _tsc = tsc;
    _kv = kv;
    _isBankVerified = isBankVerified;
    _isUpiVerified = isUpiVerified;
    _kycData = kycData;
  ...
  User.fromJson(dynamic json) {
    ...
    _isBankVerified = json['bank_verified'];
    _isUpiVerified = json['upi_verified'];
  ...
  Map<String, dynamic> toJson() {
    ...
    map['tsc'] = _tsc;
    map['kv'] = _kv;
    map['bank_verified'] = _isBankVerified;
    map['upi_verified'] = _isUpiVerified;
...
class Insights {
  ...
  factory Insights.fromJson(Map<String, dynamic> json) => Insights(
        ...
        nextInstallmentDate: json["next_installment_date"] == null
            ? null
            : json["next_installment_date"].toString(),
      );
