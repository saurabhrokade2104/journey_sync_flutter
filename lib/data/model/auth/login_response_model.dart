...
class User {
  User({
    ...
    _tsc = tsc;
    _regStep=regStep;
    _deviceDataComplete=deviceDataComplete;
  ...
  User.fromJson(dynamic json) {
    ...
    _deviceDataComplete = json['device_data_complete'].toString();
  ...
  dynamic get deviceDataComplete => _deviceDataComplete;
  ...
  Map<String, dynamic> toJson() {
    ...
    map['device_data_complete'] = _deviceDataComplete;
    if (_address != null) {
