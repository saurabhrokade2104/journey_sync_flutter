...
class Loans {
  Loans({List<Data>? data, dynamic nextPageUrl}) {
    _data = data;
...
class Data {
  ...
  Data.fromJson(dynamic json) {
    ...
    _perInstallment = json['per_installment'] != null
        ? json['per_installment'].toString()
        : '';
    _installmentInterval = json['installment_interval'] != null
        ? json['installment_interval'].toString()
        : '';
    _delayValue =
        json['delay_value'] != null ? json['delay_value'].toString() : '';
    _chargePerInstallment = json['charge_per_installment'] != null
        ? json['charge_per_installment'].toString()
        : '';
    _delayCharge =
        json['delay_charge'] != null ? json['delay_charge'].toString() : '';
    _givenInstallment = json['given_installment'] != null
        ? json['given_installment'].toString()
        : '';
    _totalInstallment = json['total_installment'] != null
        ? json['total_installment'].toString()
        : '';
...
class Plan {
  ...
  Plan.fromJson(dynamic json) {
    ...
    _name = json['name'];
    _minimumAmount = json['minimum_amount'] != null
        ? json['minimum_amount'].toString()
        : '0';
    _maximumAmount =
        json['maximum_amount'] != null ? json['maximum_amount'].toString() : '';
    _perInstallment = json['per_installment'] != null
        ? json['per_installment'].toString()
        : '';
    _installmentInterval = json['installment_interval'] != null
